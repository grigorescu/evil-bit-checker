...
Regardless of your experience level with Zeek, there are ways that you could help. If you submit a pull request with a proposed change, an extensive set of `continuous integration tests <https://github.com/grigorescu/evil-bit-checker/actions>`_ will run via `GitHub Actions <https://docs.github.com/en/free-pro-team@latest/actions>`_. These help ensure the quality of the package.


Reporting bugs or improvement ideas
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Issues are tracked on `GitHub <https://github.com/grigorescu/evil-bit-checker/issues>`_. There's an issue template that helps capture the necessary information.

Improving the documentation
^^^^^^^^^^^^^^^^^^^^^^^^^^^

`The documentation <https://grigorescu.github.io/evil-bit-checker/>`_ is hosted on `GitHub Pages <https://docs.github.com/en/free-pro-team@latest/github/working-with-github-pages>`_

Documentation is auto-generated by `Zeekygen <https://github.com/zeek/zeek/blob/master/scripts/zeekygen/example.zeek>`_ comments in the `scripts <https://github.com/grigorescu/evil-bit-checker/tree/master/scripts>`_ and `reStructuredText <https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html>`_ files in `docs/ <https://github.com/grigorescu/evil-bit-checker/tree/master/docs>`_.
...
This package comes with a `test suite <https://github.com/grigorescu/evil-bit-checker/tree/master/tests/evil-bit-checker>`_, using `btest <https://github.com/zeek/btest>`_. Each Zeek script is analyzed for code coverage by the tests, and stats are reported via `coveralls <https://coveralls.io/repos/github/grigorescu/evil-bit-checker?branch=master>`_.
